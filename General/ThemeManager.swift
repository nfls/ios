...
class ThemeManager{
    ...
    struct ThemeSetting{
        ...
        let mintGreen = Theme(style: .black, titleBackgroundColor: UIColor.pantonePMS319(), titleTextColor: UIColor.white, titleButtonColor: UIColor.white)
        let blueGreen = Theme(style: .black, titleBackgroundColor: UIColor.pantonePMS306(), titleTextColor: UIColor.white, titleButtonColor: UIColor.white)
